            ...
            <div class="grid grid-cols-1 md:grid-cols-[1.05fr_minmax(0,1fr)] gap-8 items-center">
                ...
                <div class="space-y-4">
                    ...
                    <p class="text-sm md:text-base text-slate-600 dark:text-slate-300 max-w-md">
                        This is a secure area of the application. For your safety, we need you to confirm your password before continuing with this action.
                    </p>
                </div>

                {{-- Right: confirm form card --}}
                <div class="rounded-[18px] border border-slate-200 bg-white/95 shadow-[0_18px_40px_rgba(148,163,184,0.35)] p-6
                    ...
                    <div class="mb-4">
                        ...
                        <p class="mt-1 text-xs text-slate-500 dark:text-slate-400">
                            Enter your current password to verify it’s really you.
                        </p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('password.confirm') }}" class="space-y-4">
                        ...
                        <div class="flex items-center justify-between pt-2 text-xs">
                            <p class="text-slate-500 dark:text-slate-400 max-w-[220px]">
                                Your password is never shared; this check is only for security.
                            </p>
                    ...
                    <p class="mt-4 text-[0.7rem] text-slate-400 dark:text-slate-500">
                        If you didn’t intend to perform this action, you can safely close this page or navigate elsewhere.
                    </p>
                </div>
